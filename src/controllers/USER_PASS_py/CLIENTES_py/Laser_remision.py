...
def Cliente_cards_laser_remision():
    try:
        ...
        WITH PrecioProd AS (
            ...
            FROM SAE80EMPRE01.dbo.PRECIO_X_PROD01
            WHERE CVE_PRECIO = 1
        ),
        Inve01 AS (
            SELECT CVE_ART, UNI_EMP, [STATUS], DESCR
            FROM SAE80EMPRE01.dbo.INVE01
            WHERE [STATUS] = 'A'
        ),
        FotoInve AS (
        ...
        SELECT DISTINCT
            ...
            ESP.EMPAQ,
            F.FOTO
        FROM SAE80EMPRE01.dbo.LTPD01 AS L
        LEFT JOIN PrecioProd P ON L.CVE_ART = P.CVE_ART COLLATE SQL_Latin1_General_CP1_CI_AS
        LEFT JOIN Inve01 I ON L.CVE_ART = I.CVE_ART COLLATE SQL_Latin1_General_CP1_CI_AS
